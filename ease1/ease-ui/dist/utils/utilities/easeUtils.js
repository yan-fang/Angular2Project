define(['angular'], function(angular) {
    ...
    function($stateProvider, easeFilesProvider, easeTemplatesProvider, EaseConstant,
      ...
      function addAccount(stateName, parentState) {
        $stateProvider.state(stateName, {
          ...
          parent: parentState,
          resolve: {
            'extPaymentContentData': function($ocLazyLoad, $q, $injector, contentOneFactory, ContentConstant) {
          ...
          onEnter: function(EaseModalService, easeTemplates) {
  ...
  ]).factory('EASEUtilsFactory', function($http, $q, $state, $location, $sessionStorage, $rootScope, $animate,
    $window,
    $document, $timeout, $injector, Restangular, EaseConstantFactory, EaseConstant, easeExceptionsService,
    EaseLocalizeService, CreditCardCosLink, LogOutLinks, ContentConstant, prefetchFactory) {

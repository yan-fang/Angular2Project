define(['angular'], function(angular) {
  ...
  angular.module('EaseProperties', []).constant('EaseConstant', {
    ...
    baseUrl: '@@baseUrl',
    kBuildVersion: '@@buildVersion',
    kBuildVersionPath: '@@buildVersion' ? '/ver@@buildVersion' : '',
    env: {
      type: 'dev',
      source: '/ease-ui/dist'
    },
    nextButtonImg: '/ease-ui@@PathBuildVersion_/dist/features/AccountDetail/images/btn-next.svg',
    prevButtonImg: '/ease-ui@@PathBuildVersion_/dist/features/AccountDetail/images/btn-prev.svg',
    atmFilterImg: '/ease-ui@@PathBuildVersion_/dist/images/icon_filter.svg',
    datePickerImg: '/ease-ui@@PathBuildVersion_/dist/images/date-picker.png',
    cautionImg: '/ease-ui@@PathBuildVersion_/dist/images/modal-icon-caution.svg',
    ...
    kPathUMMPaymentemplate: '/ease-ui@@PathBuildVersion_/dist/features/UMMPayment/',
    kPathTransactiontemplate: '/ease-ui@@PathBuildVersion_/dist/features/Transfer',
    kPathCroptemplate: '/ease-ui@@PathBuildVersion_/dist/features/CustomerSettings/html/',
    loading: 'loading',
    deposits: 'DEPOSITS',
    ...
    customerSettings: {
      ...
      accountPreference: {
        baseImageLocation: '/ease-ui@@PathBuildVersion_/dist/features/CustomerSettings/images/',
        deleteICON: '/ease-ui@@PathBuildVersion_/dist/features/CustomerSettings/images/clearfield.png',
        editICON: '/ease-ui@@PathBuildVersion_/dist/features/CustomerSettings/images/customerSettingsEdit.png',
        checkICON: '/ease-ui@@PathBuildVersion_/dist/features/CustomerSettings/images/profileCheckmarkIcon.png',
    ...
    kDefaultPdfUrl: '/ease-ui@@PathBuildVersion_/dist/file/NotFound.pdf',
    kDefaultPdfScale: 1.6,

    easeHeaderOptions: {
      capOneIcon: '/ease-ui@@PathBuildVersion_/dist/features/AccountSummary/images/capital_one_logo.svg',
      sneakPeekIcon: '/ease-ui@@PathBuildVersion_/dist/features/Login/images/sneak-peek.svg',

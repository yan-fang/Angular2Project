  ...
  angular
              .module('AutoLoanConstantsModule', [])
                .constant('AutoLoanMoreServicesConstants', {
                  ...
                  transferActivityUrl: 'https://secure-qa2.int.capitalone360qa.com/myaccount/' +
                  'banking/transferDepositOverview?execution=e7s1&stateId=displayTransferDepositOverview&dnr=1',
                ...
                .constant('AutoLoanMappings', {
                  Pay: 'AutoLoanPayment',
                  AutoLoanTrackerPayment:'AutoLoanTrackerPayment',
                  moreServices: 'moreServices',
                  autoLoanTracker: 'autoLoanTracker'
                });
}); //end define

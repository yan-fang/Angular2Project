define(
  ...
  function(angular) {
    ...
    //----------------------------------- Bank Configuration -------------------------------------------------------------
    var basePath = "/ease-ui/bower_components/Bank/@@version/";

    function BankModuleConfig(
      $stateProvider,
      easeFilesProvider,
         ...
         */
          DebitModule: function getDebit($ocLazyLoad) {
            $ocLazyLoad
              .load({
                files: [
                  "./ease-ui/bower_components/Debit/Debit-module.js?t=" +
                    Date.now()
                ]
              })
          ...
          CheckImageComponent: function getCheckImageComponent($ocLazyLoad) {
            return $ocLazyLoad.load({
              files: [
                basePath +
                  "features/components/checkImage/checkImage-directive.js",
                basePath +
                  "features/components/checkImage/checkImage-service.js"
              ]
            });
          },
          BankEnvironmentProperties: function getBankFeature($ocLazyLoad) {
            return $ocLazyLoad.load({
              files: [basePath + "Bank-constant.js"]
            });
          },
          BankExtensibilityBar: function getBankFeature($ocLazyLoad) {
            return $ocLazyLoad.load({
              files: [
                basePath +
                  "features/extensibilitybar/extensibilitybar-directive.js",
                basePath +
                  "features/extensibilitybar/extensibilitybar-controller.js",
                basePath +
                  "features/extensibilitybar/extensibilitybar-service.js"
              ]
            });
          },
          accountDetailsData: function getAccountDetailsData(
            BankService,
            $stateParams,
            $q
          ) {
            ...
            BankService
              .getBankAccountDetailsFromOL(
                $stateParams.accountReferenceId,
                $stateParams.accountDetails.lineOfBusiness,
                $stateParams.accountDetails.productId
              )
              .then(function(data) {
          ...
          memoComponent: function getCheckImageComponent($ocLazyLoad) {
            return $ocLazyLoad.load({
              files: [basePath + "features/components/memo/memo-directive.js"]
            });
          },
          formlyComponents: function getFormlyComponents($ocLazyLoad) {
            return $ocLazyLoad.load({
              files: [
                basePath +
                  "features/components/formlyTemplates/money-input-directive.js"
              ]
            });
          },
          characterCounterComponent: function getCharacterCounterComponent(
            $ocLazyLoad
          ) {
            return $ocLazyLoad.load({
              files: [
                basePath +
                  "features/components/characterCounter/characterCounter-directive.js"
              ]
            });
          },
        ...
        resolve: {
          BillPayModule: function getBillPay($ocLazyLoad) {
            $ocLazyLoad
              .load({
                files: [
                  "./ease-ui/bower_components/BillPay/BillPay-module.js?t=" +
                    Date.now()
                ]
              })
              .then(function(response) {
          ...
          TransactionsComponent: function getTransactionsController(
            $ocLazyLoad
          ) {
            return $ocLazyLoad.load({
              files: [
          ...
          BankUpcomingTransactions: function getBankUpcomingController(
            $ocLazyLoad
          ) {
            return $ocLazyLoad.load({
              files: [
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-controller.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-cardController.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-cardDetailController.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-cardDirective.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-directive.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-slickSlider.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-addMoreCardDirective.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-helpers.js",
                basePath +
                  "features/upcomingTransactions/upcomingTransactions-filters.js"
              ]
            });
          },
          BankUpcomingService: function getBankUpcomingService(
            $ocLazyLoad,
            $injector
          ) {
            return $ocLazyLoad
              .load({
                files: [
                  basePath +
                    "features/upcomingTransactions/upcomingTransactions-services.js"
                ]
              })
          ...
          BankDisputeController: function getBankDisputeController(
            $ocLazyLoad
          ) {
            return $ocLazyLoad.load({
              files: [
                ...
                basePath +
                  "features/dispute/retail/retail-dispute-formly-configuration.js",
      ...
      var bankViewDetailsModalState = {
        ...
        resolve: {
          BankViewDetailsHelper: function getBankViewDetailsHelperService(
            $ocLazyLoad
          ) {
            return $ocLazyLoad.load({
              files: [basePath + "Bank-viewDetailsHelper.js"]
            });
          }
        },
      ...
      var retailDisputeModalState = {
        ...
        templateUrl: (
          basePath +
            "features/dispute/retail/partials/Retail-Dispute-Index.html"
        ),
        params: {
          transactionId: "",
          disputeType: "",
        ...
        resolve: {
          ...
          RetailDisputeController: function getBankDisputeController(
            $ocLazyLoad
          ) {
            return $ocLazyLoad.load({
              files: [
                basePath +
                  "features/dispute/retail/retail-dispute-controller.js"
              ]
            });
          }
        }
      ...
      var bankDisclosuresModalState = {
        ...
        resolve: {
          ...
          agreementDetailsData: function getAgreementDetailsData(
            BankViewDetailsHelper,
            $stateParams,
            $q,
            accountDetailsData
          ) {
            ...
            BankViewDetailsHelper
              .getAgreementsFromOL(
                $stateParams.accountReferenceId,
                accountDetailsData.accountDetails.productId
              )
              .then(function(data) {
                deferred.resolve(data);
              });
      ...
      var statementOpenModalState = {
        ...
        parent: bankTransactionState,
        resolve: {
          BankStatementsService: function getBankStatementsService(
            $ocLazyLoad,
            $injector
          ) {
            return $ocLazyLoad
          ...
          lstStatementData: function(
            BankStatementsService,
            accountDetailsData
          ) {
            console.log("Inside BankStatement Module");
            return BankStatementsService.getBankStatements(
              accountDetailsData.accountRefId
            );
          }
        },
        ...
        controllerAs: "stCtrl",
        templateUrl: (
          basePath + "features/statements/partial/Bank-statements.html"
        )
      };
      ...
      var cardDetailsModalState = {
        ...
        templateUrl: (
          basePath +
            "features/upcomingTransactions/partials/upcomingTransactions-cardDetails.html"
        )
      };
      ...
      var moreServicesModalState = {
        ...
        templateProvider: function(
          ...
          if (
            BankAccountUtilities.isRetailAccount(
              BankAccountDetailsFactory.getAccountDetails().subCategory
            )
          ) {
            return $templateFactory.fromUrl(
              basePath +
                "features/moreServices/html/moreServices-retail-index.html"
            );
          }
          return $templateFactory.fromUrl(
            basePath + "features/moreServices/html/moreServices-index.html"
          );
        },
        resolve: {
          BankMoreServicesService: function getBankMoreServicesService(
            $ocLazyLoad,
            $injector
          ) {
            return $ocLazyLoad
      ...
      var BankMapState = {
        name: "BankDetails.transactions.map",
        url: "",
        controller: "mapModalController",
        controllerAs: "mapCtrl",
        templateUrl: "/ease-ui/dist/partials/easeGoogleMap.html",
        params: {
          merchant: null,
          location: null
        }
          ...
          getBillPayDependency: function getBillPayDependency($ocLazyLoad) {
            return $ocLazyLoad.load({
              ...
              files: [
                "./ease-ui/bower_components/BillPay/BillPay-module.js?t=" +
                  timestamp,
                "./ease-ui/bower_components/BillPay/directives/makePayment/makeModal-directive.js?t=" +
                  timestamp,
                "./ease-ui/bower_components/BillPay/features/Payment/MakePayment/MakePayment-controller.js?t=" +
                  timestamp,
      ...
      transferStateProvider.set(
        bankTransactionState,
        "BankDetails.transfer",
        "BankDetails.transferSuccess",
        "BankDetails.transferCancel",
        "BankDetails.transferCancelConfirm",
        "BankDetails.transferError",
        "BankDetails.transferEdit",
        "/Transfer"
      );
      ...
      $stateProvider.state(BankMapState);
    ...
    function BankModuleRun(formlyConfig) {
      ...
      formlyConfig.setType({
        ...
        extends: "input",
        templateUrl: (
          basePath + "features/components/formlyTemplates/datepicker.html"
        ),
        controller: [
          "$scope",
          "$filter",
          function($scope, $filter) {
            ...
            $scope.$watch("datePicker.selected", function() {
              $scope.model[$scope.options.key] = $filter("date")(
                vm.datePicker.selected,
                vm.datePicker.displayFormat
              );
      ...
      formlyConfig.setType({
        ...
        extends: "input",
        templateUrl: (
          basePath + "features/components/formlyTemplates/money-input.html"
        )
      });
      formlyConfig.setType({
        ...
        templateUrl: (
          basePath +
            "features/components/formlyTemplates/textarea-countdown.html"
        ),
        controller: [
          "$scope",
          function($scope) {
            $scope.$watch("to.countdownOptions.isCountNegative", function(
              newValue
            ) {
      ...
      formlyConfig.setType({
        ...
        extends: "input",
        templateUrl: (
          basePath + "features/components/formlyTemplates/phone-input.html"
        ),
        controller: [
          "$scope",
          function($scope) {
      ...
      formlyConfig.setType({
        ...
        extends: "input",
        templateUrl: (
          basePath + "features/components/formlyTemplates/radio-input.html"
        )
      });
      formlyConfig.setType({
        name: "emailInput",
        extends: "input",
        templateUrl: (
          basePath + "features/components/formlyTemplates/email-input.html"
        ),
        controller: [
          "$scope",
          function($scope) {
      ...
      formlyConfig.setWrapper([
        {
          ...
          templateUrl: (
            basePath +
              "features/components/formlyTemplates/required-wrapper.html"
          )
        }
      ]);
      formlyConfig.setWrapper([
        {
          ...
          templateUrl: (
            basePath +
              "features/components/formlyTemplates/tooltip-label-wrapper.html"
          )
        }
      ]);
    }

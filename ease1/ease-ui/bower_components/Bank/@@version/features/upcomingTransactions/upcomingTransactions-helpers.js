  ...
  'use strict';
    angular
        ...
        var actionModalTemplateType = {
          ...
          'TRANSFER_P2P' : BankFiles.getFilePath('features/upcomingTransactions/partials/actionModal/upcomingTransactions-cardDetailsTransfersP2P.html'),
          ...
          'SECUREDPAPERCHECK' : BankFiles.getFilePath('features/upcomingTransactions/partials/actionModal/upcomingTransactions-cardDetailsWrittenCheck.html')
        };
            ...
            transactionSourceOperationMap = {
              'Scheduled': {
                'TRANSFER_P2P': {
                  ...
                  transactionCategory: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.category.p2p"],
                  buttonEnabled: {'360': true, 'retail': true}
                },
                'TRANSFER_DEPOSIT': {
                  buttonCls: 'edit-transfer-btn',
                  buttonName: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.edit.transfer.button.name"],
                ...
                'TRANSFER_WITHDRAW': {
                  ...
                  link: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.cancel.transfer.button.name"],
                  transactionCategory: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.category.transfer"],
                  buttonEnabled: {'360': false, 'retail': false}
                },
                'CreditCardPay': {
              ...
              'Outstanding': {
                'SECUREDPAPERCHECK': {
                  buttonCls: "delete-check-btn",
                  buttonName: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.edit.check.button.name"],
                  link: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.delete.check.button.name"],
                  transactionCategory: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.category.secure.paper.check"],
                  buttonEnabled: {'360': false, 'retail': false}
                },
                'default': {
                  buttonCls: "delete-check-btn",
                  buttonName: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.delete.record.button.name"],
                  link: i18nUpcomingTransactions["ease.bank.upcomingTransactions.card.manage.record.button.name"],
                  transactionCategory: '',
                  buttonEnabled: {'360': false, 'retail': false}
                }
              },

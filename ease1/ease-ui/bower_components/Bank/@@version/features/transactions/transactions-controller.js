define(['angular'], function (angular) {
  ...
  function BankTransactionController(accountDetailsData, BankTransactionsFactory, BankConstants, BankPubSubFactory,
    ...
    var transactionValueToTemplateMap = {
      ...
      '1051': BankFiles.getFilePath('features/transactions/partials/ETS-Retail-BillPay.html'),
      '1055_ACH': BankFiles.getFilePath('features/transactions/partials/ETS-Retail-ACH-Billpay.html'),
    ...
    function getTemplate(transaction) {
      return transactionValueToTemplateMap[transaction.transactionType.value] ?
